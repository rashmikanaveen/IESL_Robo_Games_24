        ...
        while True:
            ...
            if not object_grabed:
                ...
                if largest_target_red_contour is not None and cv2.contourArea(largest_target_red_contour) > 0:
                    ...
                    if position == 'left':
                        turn_left(my_kobuki, 1)
                        cv2.putText(displayCopy, "Turning Left to green", (10, 30),
                                    cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
                    elif position == 'right':
                        turn_right(my_kobuki, 1)
                        cv2.putText(displayCopy, "Turning Right to green", (10, 30),
                                    cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
                    elif position == 'center':
                        # Move towards the red object
                        move_forward_optimized(my_kobuki)
                        cv2.putText(displayCopy, "Moving Forward to green", (10, 30),
                                    cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
                    ...
                    if current_red_area > STOP_AREA_THRESHOLD:
                        ...
                        my_kobuki.move(0, 0, 0)
                        cv2.putText(displayCopy, "Green object large. Stopping.", (10, 60),
                                    cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
                        push_completed = True
                        break
                ...
                if not target_red_detected:
                    ...
                    if rotation_counter >= MAX_ROTATIONS:
                        ...
                        my_kobuki.move(0, 0, 0)
                        cv2.putText(displayCopy, "Target green object not found. Stopping.", (10, 30),
                                    cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
                        break
                    else:
                        turn_left(my_kobuki, 1)
                        ...
                        cv2.putText(displayCopy, f"Searching for green... Rotation {rotation_counter*10}°", (10, 30),
                                    cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
